...
void OLED_ClearArea(int16_t X, int16_t Y, uint8_t Width, uint8_t Height);   // 清楚指定区域
...
void OLED_ShowString(int16_t X, int16_t Y, char *String, uint8_t FontSize); // 中英文通用
